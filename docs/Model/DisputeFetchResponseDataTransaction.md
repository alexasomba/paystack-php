...
**fees** | **int** |  |
**fees_split** | **int** |  |
**authorization** | [**\Alexasomba\\Paystack\Model\DisputeFetchResponseDataTransactionAuthorization**](DisputeFetchResponseDataTransactionAuthorization.md) |  |
**customer** | [**\Alexasomba\\Paystack\Model\DisputeFetchResponseDataTransactionCustomer**](DisputeFetchResponseDataTransactionCustomer.md) |  |
**plan** | **object** |  |
**subaccount** | **object** |  |
**split** | **object** |  |
**order_id** | **mixed** |  |
