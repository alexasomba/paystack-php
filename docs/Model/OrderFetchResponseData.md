...
**transaction** | **int** |  |
**is_gift** | **bool** |  |
**payer** | [**\Alexasomba\\Paystack\Model\TransactionFetchResponseDataCustomer**](TransactionFetchResponseDataCustomer.md) |  |
**fully_refunded** | **bool** |  |
**refunded_amount** | **int** |  |
**items** | [**\Alexasomba\\Paystack\Model\OrderItemsArray[]**](OrderItemsArray.md) |  |
