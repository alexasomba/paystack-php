...
class TransferRecipientCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets accountNumber
     *
     * @param string $accountNumber Recipient's bank account number
     *
     * @return self
     */
     ...
     * Sets bankCode
     *
     * @param string $bankCode Recipient's bank code. You can get the list of Bank Codes by calling the List Banks endpoint
     *
     * @return self
     */
     ...
     *
     * @param string|null $authorizationCode An authorization code from a previous transaction
     *
     * @return self
     */
