 ...
 */
class OrderFetchResponseDataLineItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderFetchResponse_data_line_items_inner';
