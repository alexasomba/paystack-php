...
class VirtualTerminalAddSplitCodeResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bearer_subaccount'] === null && !$this->isNullableSetToNull('bearer_subaccount')) {
     ...
     *
     * @param mixed|null $bearer_subaccount bearer_subaccount
     *
     * @return self
     */
    public function setBearerSubaccount($bearer_subaccount)
    {
        if (is_null($bearer_subaccount)) {
            array_push($this->openAPINullablesSetToNull, 'bearer_subaccount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bearer_subaccount', $nullablesSetToNull);
            if ($index !== FALSE) {
