...
class OrderShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shippingFee'] === null) {
     ...
     * Sets streetLine
     *
     * @param string $streetLine The address of for the delivery
     *
     * @return self
     */
     ...
     * Sets shippingFee
     *
     * @param int $shippingFee Amount should be in the subunit of the supported currency (e.g. kobo for NGN, pesewas for GHS, cents for ZAR/USD/KES). For XOF, the amount is the same as the base units (not multiplied by 100).
     *
     * @return self
     */
    public function setShippingFee($shippingFee)
    {
        if (is_null($shippingFee)) {
            throw new \InvalidArgumentException('non-nullable shippingFee cannot be null');
        }
     ...
     * Sets deliveryNote
     *
     * @param string|null $deliveryNote Extra details to be aware of for the delivery
     *
     * @return self
     */
