 ...
 */
class TransactionCheckAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionCheckAuthorization';
    ...
    */
     ...
     * Sets amount
     *
     * @param int $amount Amount should be in the subunit of the supported currency (e.g. kobo for NGN, pesewas for GHS, cents for ZAR/USD/KES). For XOF, send the amount multiplied by 100 even though the currency does not use fractional subunits.
     *
     * @return self
     */
