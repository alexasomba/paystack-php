...
class ProductUpdateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['notification_emails'] === null && !$this->isNullableSetToNull('notification_emails')) {
        ...
        if ($this->container['stock_threshold'] === null && !$this->isNullableSetToNull('stock_threshold')) {
            $invalidProperties[] = "'stock_threshold' can't be null";
        }
        if ($this->container['expires_in'] === null && !$this->isNullableSetToNull('expires_in')) {
