...
class SubscriptionListResponseArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cronExpression'] === null && !$this->isNullableSetToNull('cronExpression')) {
            $invalidProperties[] = "'cronExpression' can't be null";
        }
        if ($this->container['nextPaymentDate'] === null && !$this->isNullableSetToNull('nextPaymentDate')) {
     ...
     *
     * @param string|null $nextPaymentDate nextPaymentDate
     *
     * @return self
     */
    public function setNextPaymentDate($nextPaymentDate)
    {
        if (is_null($nextPaymentDate)) {
            array_push($this->openAPINullablesSetToNull, 'nextPaymentDate');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('nextPaymentDate', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets plan
     *
     * @return \Alexasomba\Paystack\Model\SubscriptionListResponseArrayPlan
     */
     ...
     * Sets plan
     *
     * @param \Alexasomba\Paystack\Model\SubscriptionListResponseArrayPlan $plan plan
     *
     * @return self
     */
     ...
     * Gets authorization
     *
     * @return \Alexasomba\Paystack\Model\SubscriptionListResponseArrayAuthorization
     */
     ...
     * Sets authorization
     *
     * @param \Alexasomba\Paystack\Model\SubscriptionListResponseArrayAuthorization $authorization authorization
     *
     * @return self
     */
