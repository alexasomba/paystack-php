...
class SubscriptionListResponseArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cron_expression'] === null && !$this->isNullableSetToNull('cron_expression')) {
            $invalidProperties[] = "'cron_expression' can't be null";
        }
        if ($this->container['next_payment_date'] === null && !$this->isNullableSetToNull('next_payment_date')) {
