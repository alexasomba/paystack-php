...
class DisputeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets refundAmount
     *
     * @param int $refundAmount The amount to refund, in the subunit of your currency
     *
     * @return self
     */
     ...
     *
     * @param string|null $uploadedFilename Filename of attachment returned via response from the Dispute upload URL
     *
     * @return self
     */
