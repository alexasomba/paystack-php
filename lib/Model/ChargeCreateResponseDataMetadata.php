 ...
 */
class ChargeCreateResponseDataMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChargeCreateResponse_data_metadata';
