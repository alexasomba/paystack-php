...
class StorefrontCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['welcome_message'] === null && !$this->isNullableSetToNull('welcome_message')) {
        ...
        if ($this->container['digital_product_expiry'] === null && !$this->isNullableSetToNull('digital_product_expiry')) {
     ...
     * Gets contacts
     *
     * @return \Alexasomba\Paystack\Model\StorefrontContactsArray[]
     */
     ...
     * Sets contacts
     *
     * @param \Alexasomba\Paystack\Model\StorefrontContactsArray[] $contacts contacts
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $welcome_message welcome_message
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $digital_product_expiry digital_product_expiry
     *
     * @return self
     */
