 ...
 */
class SettlementTransactionsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SettlementTransactionsResponse';
