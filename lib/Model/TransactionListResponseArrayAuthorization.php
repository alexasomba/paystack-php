...
class TransactionListResponseArrayAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expMonth'] === null && !$this->isNullableSetToNull('expMonth')) {
            $invalidProperties[] = "'expMonth' can't be null";
        }
        if ($this->container['expYear'] === null && !$this->isNullableSetToNull('expYear')) {
            $invalidProperties[] = "'expYear' can't be null";
        }
        if ($this->container['channel'] === null && !$this->isNullableSetToNull('channel')) {
            $invalidProperties[] = "'channel' can't be null";
        }
        if ($this->container['cardType'] === null && !$this->isNullableSetToNull('cardType')) {
            $invalidProperties[] = "'cardType' can't be null";
        }
        if ($this->container['bank'] === null && !$this->isNullableSetToNull('bank')) {
            $invalidProperties[] = "'bank' can't be null";
        }
        if ($this->container['countryCode'] === null && !$this->isNullableSetToNull('countryCode')) {
        ...
        if ($this->container['signature'] === null && !$this->isNullableSetToNull('signature')) {
    ...
    {
        if (is_null($expMonth)) {
            array_push($this->openAPINullablesSetToNull, 'expMonth');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expMonth', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($expYear)) {
            array_push($this->openAPINullablesSetToNull, 'expYear');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expYear', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($cardType)) {
            array_push($this->openAPINullablesSetToNull, 'cardType');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cardType', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
