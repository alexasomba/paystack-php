...
class PaymentRequestUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets hasInvoice
     *
     * @param object[]|null $hasInvoice Set to true to create a draft invoice (adds an auto incrementing invoice number if none is provided) even if there are no line_items or tax passed
     *
     * @return self
     */
