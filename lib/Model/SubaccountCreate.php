...
class SubaccountCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'metadata' => '\Alexasomba\Paystack\Model\SubaccountCreateMetadata'
    ];
    ...
    */
     ...
     * Sets settlementBank
     *
     * @param string $settlementBank Bank code for the bank. You can get the list of Bank Codes by calling the List Banks endpoint.
     *
     * @return self
     */
     ...
     *
     * @param float $percentageCharge The percentage the main account receives from each payment made to the subaccount
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Alexasomba\Paystack\Model\SubaccountCreateMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \Alexasomba\Paystack\Model\SubaccountCreateMetadata|null $metadata metadata
     *
     * @return self
     */
