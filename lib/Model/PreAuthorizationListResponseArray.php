 ...
 */
class PreAuthorizationListResponseArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreAuthorizationListResponseArray';
