...
class DisputeEvidence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets customerPhone
     *
     * @param string $customerPhone Customer mobile number
     *
     * @return self
     */
     ...
     * Sets serviceDetails
     *
     * @param string $serviceDetails Details of service offered
     *
     * @return self
     */
     ...
     * Sets deliveryDate
     *
     * @param \DateTime|null $deliveryDate ISO 8601 representation of delivery date (YYYY-MM-DD)
     *
     * @return self
     */
