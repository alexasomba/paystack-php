...
class OrderCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipping_fees' => 'int',
        'shipping_method' => '\Alexasomba\Paystack\Model\OrderCreateResponseDataShippingMethod',
        'metadata' => 'object',
        'order_code' => 'string',
        'status' => 'string',
        'refunded' => 'bool',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['expiration_date'] === null && !$this->isNullableSetToNull('expiration_date')) {
     ...
     *
     * @param \Alexasomba\Paystack\Model\OrderCreateResponseDataShippingMethod|null $shipping_method shipping_method
     *
     * @return self
     */
