 ...
 */
class PaymentRequestViewResponseDataCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRequestViewResponse_data_customer';
