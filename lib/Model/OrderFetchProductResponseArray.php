...
class OrderFetchProductResponseArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['variant_price'] === null && !$this->isNullableSetToNull('variant_price')) {
            $invalidProperties[] = "'variant_price' can't be null";
        }
        if ($this->container['variant_code'] === null && !$this->isNullableSetToNull('variant_code')) {
        ...
        if ($this->container['delivery_note'] === null && !$this->isNullableSetToNull('delivery_note')) {
            $invalidProperties[] = "'delivery_note' can't be null";
        }
        if ($this->container['shipping_fee'] === null && !$this->isNullableSetToNull('shipping_fee')) {
     ...
     * Sets variant_id
     *
     * @param mixed|null $variant_id variant_id
     *
     * @return self
     */
     ...
     * Sets variant_price
     *
     * @param mixed|null $variant_price variant_price
     *
     * @return self
     */
     ...
     * Sets variant_code
     *
     * @param mixed|null $variant_code variant_code
     *
     * @return self
     */
     ...
     * Sets delivery_note
     *
     * @param mixed|null $delivery_note delivery_note
     *
     * @return self
     */
     ...
     * Sets shipping_fee
     *
     * @param mixed|null $shipping_fee shipping_fee
     *
     * @return self
     */
