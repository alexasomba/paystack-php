...
class Data2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'data-2';
    ...
    protected static $openAPITypes = [
        ...
        'feeCharged' => 'int',
        'feesBreakdown' => '\Alexasomba\Paystack\Model\TransferFeesBreakdownArray[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('feeCharged', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['feeCharged'] === null) {
            $invalidProperties[] = "'feeCharged' can't be null";
        }
    ...
    {
        return $this->container['feeCharged'];
    }

    /**
     * Sets feeCharged
     *
     * @param int $feeCharged feeCharged
     *
     * @return self
     */
    public function setFeeCharged($feeCharged)
    {
        if (is_null($feeCharged)) {
            throw new \InvalidArgumentException('non-nullable feeCharged cannot be null');
        }
        $this->container['feeCharged'] = $feeCharged;
     ...
     * Gets feesBreakdown
     *
     * @return \Alexasomba\Paystack\Model\TransferFeesBreakdownArray[]|null
     */
     ...
     * Sets feesBreakdown
     *
     * @param \Alexasomba\Paystack\Model\TransferFeesBreakdownArray[]|null $feesBreakdown feesBreakdown
     *
     * @return self
     */
