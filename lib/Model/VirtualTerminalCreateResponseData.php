 ...
 */
class VirtualTerminalCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualTerminalCreateResponse_data';
