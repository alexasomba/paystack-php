...
class TransferRecipientListResponseArrayDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authorization_code'] === null && !$this->isNullableSetToNull('authorization_code')) {
            $invalidProperties[] = "'authorization_code' can't be null";
        }
        if ($this->container['account_number'] === null && !$this->isNullableSetToNull('account_number')) {
