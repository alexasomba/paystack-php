...
/**
 * VirtualTerminalDeleteSplitCode Class Doc Comment
 *
 * @category Class
 * @package  Alexasomba\Paystack
 * @author   OpenAPI Generator team
 ...
 */
class VirtualTerminalDeleteSplitCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualTerminalDeleteSplitCode';
    ...
    */
     ...
     * Sets split_code
     *
     * @param string $split_code The split code to assign to the virtual terminal
     *
     * @return self
     */
