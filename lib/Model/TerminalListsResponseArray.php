...
class TerminalListsResponseArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['serial_number'] === null && !$this->isNullableSetToNull('serial_number')) {
            $invalidProperties[] = "'serial_number' can't be null";
        }
        if ($this->container['device_make'] === null && !$this->isNullableSetToNull('device_make')) {
     ...
     * Sets device_make
     *
     * @param string|null $device_make device_make
     *
     * @return self
     */
