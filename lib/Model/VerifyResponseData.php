 ...
 */
class VerifyResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerifyResponse_data';
    ...
    */
     ...
     * Gets log
     *
     * @return \Alexasomba\\Paystack\Model\VerifyResponseDataLog
     */
     ...
     * Sets log
     *
     * @param \Alexasomba\\Paystack\Model\VerifyResponseDataLog $log log
     *
     * @return self
     */
    ...
    public function setPlanObject($plan_object)
    {
        if (is_null($plan_object)) {
            array_push($this->openAPINullablesSetToNull, 'plan_object');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('plan_object', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
