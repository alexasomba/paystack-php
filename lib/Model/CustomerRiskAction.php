...
class CustomerRiskAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('riskAction', $data ?? [], 'default');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['riskAction']) && !in_array($this->container['riskAction'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'riskAction', must be one of '%s'",
                $this->container['riskAction'],
     ...
     * Sets riskAction
     *
     * @param string|null $riskAction This determines the fraud rules that should be applied to the customer
     *
     * @return self
     */
    public function setRiskAction($riskAction)
    {
        ...
        $allowedValues = $this->getRiskActionAllowableValues();
        if (!in_array($riskAction, $allowedValues, true)) {
