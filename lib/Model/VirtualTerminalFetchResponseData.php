...
/**
 * VirtualTerminalFetchResponseData Class Doc Comment
 *
 * @category Class
 * @package  Alexasomba\Paystack
 * @author   OpenAPI Generator team
 ...
 */
class VirtualTerminalFetchResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualTerminalFetchResponse_data';
    ...
    protected static $setters = [
        ...
        'connect_account_id' => 'setConnectAccountId',
    ...
    protected static $getters = [
        ...
        'connect_account_id' => 'getConnectAccountId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('connect_account_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['connect_account_id'] === null && !$this->isNullableSetToNull('connect_account_id')) {
            $invalidProperties[] = "'connect_account_id' can't be null";
        }
    ...
    {
        return $this->container['connect_account_id'];
    }

    /**
     * Sets connect_account_id
     *
     * @param mixed|null $connect_account_id connect_account_id
     *
     * @return self
     */
    public function setConnectAccountId($connect_account_id)
    {
        if (is_null($connect_account_id)) {
            array_push($this->openAPINullablesSetToNull, 'connect_account_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('connect_account_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['connect_account_id'] = $connect_account_id;
     ...
     * Gets destinations
     *
     * @return \Alexasomba\Paystack\Model\VirtualTerminalFetchResponseDataDestinationsInner[]
     */
     ...
     * Sets destinations
     *
     * @param \Alexasomba\Paystack\Model\VirtualTerminalFetchResponseDataDestinationsInner[] $destinations destinations
     *
     * @return self
     */
