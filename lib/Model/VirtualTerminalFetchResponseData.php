...
class VirtualTerminalFetchResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'connectAccountId' => 'setConnectAccountId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('connectAccountId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['connectAccountId'] === null && !$this->isNullableSetToNull('connectAccountId')) {
            $invalidProperties[] = "'connectAccountId' can't be null";
        }
    ...
    /**
     * Gets connectAccountId
     *
     * @return mixed|null
     */
    public function getConnectAccountId()
    {
        return $this->container['connectAccountId'];
    }

    /**
     * Sets connectAccountId
     *
     * @param mixed|null $connectAccountId connectAccountId
     *
     * @return self
     */
    public function setConnectAccountId($connectAccountId)
    {
        if (is_null($connectAccountId)) {
            array_push($this->openAPINullablesSetToNull, 'connectAccountId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('connectAccountId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['connectAccountId'] = $connectAccountId;
