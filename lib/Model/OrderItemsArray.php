...
class OrderItemsArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_success_message'] === null && !$this->isNullableSetToNull('product_success_message')) {
            $invalidProperties[] = "'product_success_message' can't be null";
        }
        if ($this->container['product_redirect_url'] === null && !$this->isNullableSetToNull('product_redirect_url')) {
            $invalidProperties[] = "'product_redirect_url' can't be null";
        }
        if ($this->container['ifnull_p1_expires_in_p2_expires_in'] === null && !$this->isNullableSetToNull('ifnull_p1_expires_in_p2_expires_in')) {
        ...
        if ($this->container['product_notification_emails'] === null && !$this->isNullableSetToNull('product_notification_emails')) {
        ...
        if ($this->container['storefront_redirect_url'] === null && !$this->isNullableSetToNull('storefront_redirect_url')) {
            $invalidProperties[] = "'storefront_redirect_url' can't be null";
        }
        if ($this->container['storefront_success_message'] === null && !$this->isNullableSetToNull('storefront_success_message')) {
     ...
     *
     * @param mixed|null $product_success_message product_success_message
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $product_redirect_url product_redirect_url
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $ifnull_p1_expires_in_p2_expires_in ifnull_p1_expires_in_p2_expires_in
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $product_notification_emails product_notification_emails
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $storefront_redirect_url storefront_redirect_url
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $storefront_success_message storefront_success_message
     *
     * @return self
     */
