...
class Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'source' => '\Alexasomba\Paystack\Model\TransactionFetchResponseDataSource',
        'feesBreakdown' => 'mixed',
        'connect' => 'mixed'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('helpdeskLink', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['helpdeskLink'] === null && !$this->isNullableSetToNull('helpdeskLink')) {
            $invalidProperties[] = "'helpdeskLink' can't be null";
        }
     ...
     * Sets receiptNumber
     *
     * @param mixed|null $receiptNumber receiptNumber
     *
     * @return self
     */
    ...
    {
        return $this->container['helpdeskLink'];
    }

    /**
     * Sets helpdeskLink
     *
     * @param mixed|null $helpdeskLink helpdeskLink
     *
     * @return self
     */
    public function setHelpdeskLink($helpdeskLink)
    {
        if (is_null($helpdeskLink)) {
            array_push($this->openAPINullablesSetToNull, 'helpdeskLink');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('helpdeskLink', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['helpdeskLink'] = $helpdeskLink;
