...
/**
    ...
    public function virtualTerminalAddSplitCodeWithHttpInfo($code, $virtual_terminal_add_split_code = null, string $contentType = self::contentTypes['virtualTerminalAddSplitCode'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalAddSplitCodeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalAddSplitCodeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalAddSplitCodeResponse', []),
     ...
     *
     * @param  \Alexasomba\\Paystack\Model\VirtualTerminalCreate $virtual_terminal_create virtual_terminal_create (optional)
     ...
     * Create Virtual Terminal
     *
     * @param  \Alexasomba\\Paystack\Model\VirtualTerminalCreate $virtual_terminal_create (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['virtualTerminalCreate'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function virtualTerminalCreateWithHttpInfo($virtual_terminal_create = null, string $contentType = self::contentTypes['virtualTerminalCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalCreateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function virtualTerminalDeactivateWithHttpInfo($code, string $contentType = self::contentTypes['virtualTerminalDeactivate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalDeactivateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalDeactivateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalDeactivateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function virtualTerminalDeleteSplitCodeWithHttpInfo($code, $virtual_terminal_delete_split_code = null, string $contentType = self::contentTypes['virtualTerminalDeleteSplitCode'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalDeleteSplitCodeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalDeleteSplitCodeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalDeleteSplitCodeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function virtualTerminalDestinationAssignWithHttpInfo($code, $virtual_terminal_destination_assign = null, string $contentType = self::contentTypes['virtualTerminalDestinationAssign'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalDestinationAssignResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalDestinationAssignResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalDestinationAssignResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function virtualTerminalDestinationUnassignWithHttpInfo($code, $virtual_terminal_destination_unassign = null, string $contentType = self::contentTypes['virtualTerminalDestinationUnassign'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalDestinationUnassignResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalDestinationUnassignResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalDestinationUnassignResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function virtualTerminalFetchWithHttpInfo($code, string $contentType = self::contentTypes['virtualTerminalFetch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalFetchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalFetchResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalFetchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function virtualTerminalListWithHttpInfo($per_page = null, $page = null, string $contentType = self::contentTypes['virtualTerminalList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function virtualTerminalUpdateWithHttpInfo($code, $virtual_terminal_update = null, string $contentType = self::contentTypes['virtualTerminalUpdate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\VirtualTerminalUpdateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\VirtualTerminalUpdateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\VirtualTerminalUpdateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
