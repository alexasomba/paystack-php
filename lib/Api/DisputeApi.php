...
/**
    ...
    public function disputeDownloadWithHttpInfo($per_page = null, $page = null, $status = null, $from = null, $to = null, string $contentType = self::contentTypes['disputeDownload'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeExportResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeExportResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeExportResponse', []),
     ...
     * @param  \Alexasomba\\Paystack\Model\DisputeIdEvidence $body body (optional)
     ...
     */
    public function disputeEvidence($id, $body = null, string $contentType = self::contentTypes['disputeEvidence'][0])
    {
        list($response) = $this->disputeEvidenceWithHttpInfo($id, $body, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id The unique identifier of the dispute (required)
     * @param  \Alexasomba\\Paystack\Model\DisputeIdEvidence $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['disputeEvidence'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function disputeEvidenceWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['disputeEvidence'][0])
    {
        $request = $this->disputeEvidenceRequest($id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeAddEvidenceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeAddEvidenceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeAddEvidenceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disputeEvidenceAsync($id, $body = null, string $contentType = self::contentTypes['disputeEvidence'][0])
    {
        return $this->disputeEvidenceAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disputeEvidenceAsyncWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['disputeEvidence'][0])
    {
        $returnType = '\Alexasomba\\Paystack\Model\DisputeAddEvidenceResponse';
        $request = $this->disputeEvidenceRequest($id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function disputeEvidenceRequest($id, $body = null, string $contentType = self::contentTypes['disputeEvidence'][0])
    {
    ...
    public function disputeFetchWithHttpInfo($id, string $contentType = self::contentTypes['disputeFetch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeFetchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeFetchResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeFetchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @param  int $per_page Number of records to fetch per page (optional)
     * @param  int $page The section to retrieve (optional)
     * @param  string $status Dispute status (optional)
     * @param  string $transaction Transaction ID (optional)
     * @param  \DateTime $from The start date (optional)
     * @param  \DateTime $to The end date (optional)
    ...
    public function disputeListWithHttpInfo($per_page = null, $page = null, $status = null, $transaction = null, $from = null, $to = null, string $contentType = self::contentTypes['disputeList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     *
     * @param  int $id The unique identifier of the dispute (required)
     * @param  \Alexasomba\\Paystack\Model\DisputeIdResolve $body body (optional)
     ...
     */
    public function disputeResolve($id, $body = null, string $contentType = self::contentTypes['disputeResolve'][0])
    {
        list($response) = $this->disputeResolveWithHttpInfo($id, $body, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id The unique identifier of the dispute (required)
     * @param  \Alexasomba\\Paystack\Model\DisputeIdResolve $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['disputeResolve'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function disputeResolveWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['disputeResolve'][0])
    {
        $request = $this->disputeResolveRequest($id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeResolveResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeResolveResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeResolveResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disputeResolveAsync($id, $body = null, string $contentType = self::contentTypes['disputeResolve'][0])
    {
        return $this->disputeResolveAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disputeResolveAsyncWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['disputeResolve'][0])
    {
        $returnType = '\Alexasomba\\Paystack\Model\DisputeResolveResponse';
        $request = $this->disputeResolveRequest($id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function disputeResolveRequest($id, $body = null, string $contentType = self::contentTypes['disputeResolve'][0])
    {
    ...
    public function disputeTransactionWithHttpInfo($id, string $contentType = self::contentTypes['disputeTransaction'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeListTransactionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeListTransactionResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeListTransactionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     *
     * @param  int $id The unique identifier of the dispute (required)
     * @param  \Alexasomba\\Paystack\Model\DisputeId $body body (optional)
     ...
     */
    public function disputeUpdate($id, $body = null, string $contentType = self::contentTypes['disputeUpdate'][0])
    {
        list($response) = $this->disputeUpdateWithHttpInfo($id, $body, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id The unique identifier of the dispute (required)
     * @param  \Alexasomba\\Paystack\Model\DisputeId $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['disputeUpdate'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function disputeUpdateWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['disputeUpdate'][0])
    {
        $request = $this->disputeUpdateRequest($id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeUpdateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeUpdateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeUpdateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disputeUpdateAsync($id, $body = null, string $contentType = self::contentTypes['disputeUpdate'][0])
    {
        return $this->disputeUpdateAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disputeUpdateAsyncWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['disputeUpdate'][0])
    {
        $returnType = '\Alexasomba\\Paystack\Model\DisputeUpdateResponse';
        $request = $this->disputeUpdateRequest($id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function disputeUpdateRequest($id, $body = null, string $contentType = self::contentTypes['disputeUpdate'][0])
    {
    ...
    public function disputeUploadUrlWithHttpInfo($id, string $contentType = self::contentTypes['disputeUploadUrl'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\DisputeUploadURLResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\DisputeUploadURLResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\DisputeUploadURLResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
