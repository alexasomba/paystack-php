...
/**
     ...
     * Create Subscription
     *
     * @param  \Alexasomba\\Paystack\Model\SubscriptionCreate $subscription_create subscription_create (optional)
     ...
     * Create Subscription
     *
     * @param  \Alexasomba\\Paystack\Model\SubscriptionCreate $subscription_create (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subscriptionCreate'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function subscriptionCreateWithHttpInfo($subscription_create = null, string $contentType = self::contentTypes['subscriptionCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\SubscriptionCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\SubscriptionCreateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\SubscriptionCreateResponse', []),
     ...
     *
     * @param  \Alexasomba\\Paystack\Model\SubscriptionToggle $subscription_toggle subscription_toggle (optional)
     ...
     * Disable Subscription
     *
     * @param  \Alexasomba\\Paystack\Model\SubscriptionToggle $subscription_toggle (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subscriptionDisable'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function subscriptionDisableWithHttpInfo($subscription_toggle = null, string $contentType = self::contentTypes['subscriptionDisable'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\SubscriptionDisableResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\SubscriptionDisableResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\SubscriptionDisableResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function subscriptionFetchWithHttpInfo($code, string $contentType = self::contentTypes['subscriptionFetch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\SubscriptionFetchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\SubscriptionFetchResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\SubscriptionFetchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @param  int $plan Plan ID (optional)
    ...
    public function subscriptionListWithHttpInfo($per_page = null, $page = null, $plan = null, $customer = null, $from = null, $to = null, string $contentType = self::contentTypes['subscriptionList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\SubscriptionListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\SubscriptionListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\SubscriptionListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
