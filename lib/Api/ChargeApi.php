...
/**
     ...
     * Create Charge
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeCreateRequest $charge_create_request charge_create_request (optional)
     ...
     * Create Charge
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeCreateRequest $charge_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chargeCreate'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function chargeCreateWithHttpInfo($charge_create_request = null, string $contentType = self::contentTypes['chargeCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\ChargeCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\ChargeCreateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\ChargeCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * Submit Address
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitAddress $charge_submit_address charge_submit_address (optional)
     ...
     * Submit Address
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitAddress $charge_submit_address (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chargeSubmitAddress'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Submit Birthday
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitBirthday $charge_submit_birthday charge_submit_birthday (optional)
     ...
     * Submit Birthday
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitBirthday $charge_submit_birthday (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chargeSubmitBirthday'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function chargeSubmitBirthdayWithHttpInfo($charge_submit_birthday = null, string $contentType = self::contentTypes['chargeSubmitBirthday'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\ChargeSubmitBirthdayResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\ChargeSubmitBirthdayResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\ChargeSubmitBirthdayResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * Submit OTP
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitOTP $charge_submit_otp charge_submit_otp (optional)
     ...
     * Submit OTP
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitOTP $charge_submit_otp (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chargeSubmitOtp'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function chargeSubmitOtpWithHttpInfo($charge_submit_otp = null, string $contentType = self::contentTypes['chargeSubmitOtp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\ChargeSubmitOtpResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\ChargeSubmitOtpResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\ChargeSubmitOtpResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * Submit Phone
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitPhone $charge_submit_phone charge_submit_phone (optional)
     ...
     * Submit Phone
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitPhone $charge_submit_phone (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chargeSubmitPhone'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function chargeSubmitPhoneWithHttpInfo($charge_submit_phone = null, string $contentType = self::contentTypes['chargeSubmitPhone'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\ChargeSubmitPhoneResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\ChargeSubmitPhoneResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\ChargeSubmitPhoneResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * Submit PIN
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitPin $charge_submit_pin charge_submit_pin (optional)
     ...
     * Submit PIN
     *
     * @param  \Alexasomba\\Paystack\Model\ChargeSubmitPin $charge_submit_pin (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chargeSubmitPin'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function chargeSubmitPinWithHttpInfo($charge_submit_pin = null, string $contentType = self::contentTypes['chargeSubmitPin'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\ChargeSubmitPinResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\ChargeSubmitPinResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\ChargeSubmitPinResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
