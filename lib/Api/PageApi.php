...
/**
     ...
     * @param  \Alexasomba\\Paystack\Model\PageIdProduct $body body (optional)
     ...
     */
    public function pageAddProducts($id, $body = null, string $contentType = self::contentTypes['pageAddProducts'][0])
    {
        list($response) = $this->pageAddProductsWithHttpInfo($id, $body, $contentType);
        return $response;
    }
     ...
     * @param  \Alexasomba\\Paystack\Model\PageIdProduct $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pageAddProducts'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function pageAddProductsWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['pageAddProducts'][0])
    {
        $request = $this->pageAddProductsRequest($id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\PageAddProductsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\PageAddProductsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\PageAddProductsResponse', []),
     ...
     */
    public function pageAddProductsAsync($id, $body = null, string $contentType = self::contentTypes['pageAddProducts'][0])
    {
        return $this->pageAddProductsAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pageAddProductsAsyncWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['pageAddProducts'][0])
    {
        $returnType = '\Alexasomba\\Paystack\Model\PageAddProductsResponse';
        $request = $this->pageAddProductsRequest($id, $body, $contentType);
     ...
     */
    public function pageAddProductsRequest($id, $body = null, string $contentType = self::contentTypes['pageAddProducts'][0])
    {
    ...
    public function pageCheckSlugAvailabilityWithHttpInfo($slug, string $contentType = self::contentTypes['pageCheckSlugAvailability'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\PageCheckSlugAvailabilityResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\PageCheckSlugAvailabilityResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\PageCheckSlugAvailabilityResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * Create Page
     *
     * @param  \Alexasomba\\Paystack\Model\PageCreate $page_create page_create (optional)
     ...
     * Create Page
     *
     * @param  \Alexasomba\\Paystack\Model\PageCreate $page_create (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pageCreate'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function pageCreateWithHttpInfo($page_create = null, string $contentType = self::contentTypes['pageCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\PageCreateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\PageCreateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\PageCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function pageFetchWithHttpInfo($id, string $contentType = self::contentTypes['pageFetch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\PageFetchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\PageFetchResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\PageFetchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * List Pages
     *
     * @param  int $per_page Number of records to fetch per page (optional, default to 50)
    ...
    public function pageListWithHttpInfo($per_page = 50, $page = null, $from = null, $to = null, string $contentType = self::contentTypes['pageList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\PageListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\PageListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\PageListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     *
     * @param  int $id The unique identifier of a payment page (required)
     * @param  \Alexasomba\\Paystack\Model\PageId $body body (optional)
     ...
     */
    public function pageUpdate($id, $body = null, string $contentType = self::contentTypes['pageUpdate'][0])
    {
        list($response) = $this->pageUpdateWithHttpInfo($id, $body, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id The unique identifier of a payment page (required)
     * @param  \Alexasomba\\Paystack\Model\PageId $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pageUpdate'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function pageUpdateWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['pageUpdate'][0])
    {
        $request = $this->pageUpdateRequest($id, $body, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\PageUpdateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\PageUpdateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\PageUpdateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pageUpdateAsync($id, $body = null, string $contentType = self::contentTypes['pageUpdate'][0])
    {
        return $this->pageUpdateAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pageUpdateAsyncWithHttpInfo($id, $body = null, string $contentType = self::contentTypes['pageUpdate'][0])
    {
        $returnType = '\Alexasomba\\Paystack\Model\PageUpdateResponse';
        $request = $this->pageUpdateRequest($id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pageUpdateRequest($id, $body = null, string $contentType = self::contentTypes['pageUpdate'][0])
    {
