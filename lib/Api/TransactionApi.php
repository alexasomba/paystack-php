...
/**
     ...
     *
     * @param  \Alexasomba\\Paystack\Model\TransactionChargeAuthorization $transaction_charge_authorization transaction_charge_authorization (optional)
     ...
     * Charge Authorization
     *
     * @param  \Alexasomba\\Paystack\Model\TransactionChargeAuthorization $transaction_charge_authorization (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transactionChargeAuthorization'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function transactionChargeAuthorizationWithHttpInfo($transaction_charge_authorization = null, string $contentType = self::contentTypes['transactionChargeAuthorization'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\ChargeAuthorizationResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\ChargeAuthorizationResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\ChargeAuthorizationResponse', []),
     ...
     * @param  string $authorization_code Valid authorization code to charge (optional)
    ...
    public function transactionCheckAuthorizationRequest($email, $amount, $authorization_code = null, $currency = null, string $contentType = self::contentTypes['transactionCheckAuthorization'][0])
    {
        ...
        if ($authorization_code !== null) {
            $formParams['authorization_code'] = ObjectSerializer::toFormValue($authorization_code);
        }
        // form params
        if ($currency !== null) {
     ...
     * @param  string $status Filter by the status of the transaction (optional)
     * @param  float $customer Filter by customer ID (optional)
     * @param  string $subaccount_code Filter by subaccount code (optional)
     * @param  int $settlement Filter by the settlement ID (optional)
    ...
    public function transactionExportWithHttpInfo($from = null, $to = null, $status = null, $customer = null, $subaccount_code = null, $settlement = null, string $contentType = self::contentTypes['transactionExport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\TransactionExportResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\TransactionExportResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\TransactionExportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     *
     * @param  \Alexasomba\\Paystack\Model\TransactionInitialize $transaction_initialize transaction_initialize (optional)
     ...
     * Initialize Transaction
     *
     * @param  \Alexasomba\\Paystack\Model\TransactionInitialize $transaction_initialize (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transactionInitialize'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function transactionInitializeWithHttpInfo($transaction_initialize = null, string $contentType = self::contentTypes['transactionInitialize'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\TransactionInitializeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\TransactionInitializeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\TransactionInitializeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Alexasomba\\Paystack\Model\TransactionInitializeBadRequestModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\TransactionInitializeBadRequestModel' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\TransactionInitializeBadRequestModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @param  \DateTime $from The start date (optional)
     * @param  \DateTime $to The end date (optional)
     * @param  string $status Filter transaction by status (optional)
     * @param  string $source The origin of the payment (optional)
     * @param  string $terminal_id Filter transactions by a terminal ID (optional)
     * @param  string $virtual_account_number Filter transactions by a virtual account number (optional)
     * @param  string $customer_code Filter transactions by a customer code (optional)
     * @param  int $amount Filter transactions by a specific amount (optional)
     * @param  int $settlement The settlement ID to filter for settled transactions (optional)
     * @param  string $channel The payment method the customer used to complete the transaction (optional)
     * @param  string $subaccount_code Filter transaction by subaccount code (optional)
     * @param  string $split_code Filter transaction by split code (optional)
    ...
    public function transactionListWithHttpInfo($use_cursor = null, $next = null, $previous = null, $per_page = null, $page = null, $from = null, $to = null, $status = null, $source = null, $terminal_id = null, $virtual_account_number = null, $customer_code = null, $amount = null, $settlement = null, $channel = null, $subaccount_code = null, $split_code = null, string $contentType = self::contentTypes['transactionList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\TransactionListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\TransactionListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\TransactionListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * Partial Debit
     *
     * @param  \Alexasomba\\Paystack\Model\TransactionPartialDebit $transaction_partial_debit transaction_partial_debit (optional)
     ...
     * Partial Debit
     *
     * @param  \Alexasomba\\Paystack\Model\TransactionPartialDebit $transaction_partial_debit (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transactionPartialDebit'] to see the possible values for this operation
     *
     * @throws \Alexasomba\\Paystack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function transactionPartialDebitWithHttpInfo($transaction_partial_debit = null, string $contentType = self::contentTypes['transactionPartialDebit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\TransactionPartialDebitResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\TransactionPartialDebitResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\TransactionPartialDebitResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function transactionTotalsWithHttpInfo($from = null, $to = null, string $contentType = self::contentTypes['transactionTotals'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alexasomba\\Paystack\Model\TransactionTotalsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Alexasomba\\Paystack\Model\TransactionTotalsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Alexasomba\\Paystack\Model\TransactionTotalsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
